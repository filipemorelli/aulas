...
CREATE TABLE Customers (CustomerID INTEGER NOT NULL PRIMARY KEY auto_increment,
...
CREATE TABLE Categories (CategoryID INTEGER NOT NULL PRIMARY KEY auto_increment,
...
CREATE TABLE Employees (EmployeeID INTEGER NOT NULL PRIMARY KEY auto_increment,
                                                                LastName NVARCHAR(255),
                                                                         FirstName NVARCHAR(255),
                                                                                   BirthDate DATE,Photo NVARCHAR(255),
                                                                                                        Notes TEXT);
...
CREATE TABLE OrderDetails (OrderDetailID INTEGER NOT NULL PRIMARY KEY auto_increment,
...
CREATE TABLE Orders (OrderID INTEGER NOT NULL PRIMARY KEY auto_increment,
...
CREATE TABLE Products (ProductID INTEGER NOT NULL PRIMARY KEY auto_increment,
                                                              ProductName NVARCHAR(255),
                                                                          SupplierID INT,CategoryID INT,Unit NVARCHAR(255),
                                                                                                             Price DECIMAL(10,2));
...
CREATE TABLE Shippers (ShipperID INTEGER NOT NULL PRIMARY KEY auto_increment,
...
CREATE TABLE Suppliers (SupplierID INTEGER NOT NULL PRIMARY KEY auto_increment,
